...
mex_id_ = 'em3tata3trunc(i dcomplex[x], i double[], i dcomplex[], i dcomplex[], i int64_t[x], i double[], io dcomplex[], io dcomplex[], i int64_t[x], i double[], i double[], i double[], i int64_t[x], i int64_t[x])';
[ampole1, bmpole1] = fmpslib(mex_id_, rk, center, ampole, bmpole, nterms, center1, ampole1, bmpole1, nterms1, radius1, rnodes, weights, nphi, ntheta, 1, 1, 1, 1, 1);
