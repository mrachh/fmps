...
mex_id_ = 'em3mpmp3trunc(i dcomplex[x], i double[], i dcomplex[], i dcomplex[], i int64_t[x], i double[], io dcomplex[], io dcomplex[], i int64_t[x], i double[], i double[], i double[], i int64_t[x], i int64_t[x])';
