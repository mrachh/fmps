...
mex_id_ = 'em3taevaleh(i dcomplex[x], i double[], i dcomplex[], i dcomplex[], i int64_t[x], i double[], i double[], io dcomplex[], io dcomplex[], i double[], i double[], i int64_t[x], i int64_t[x])';
[evecs, hvecs] = fmpslib(mex_id_, rk, center, aimpole, bimpole, nterms, sphere_xyz, sphere_r, evecs, hvecs, rnodes, weights, nphi, ntheta, 1, 1, 1, 1);
